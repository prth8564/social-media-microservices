...
await client.query('CREATE TABLE IF NOT EXISTS conversations (id PRIMARY KEY,user1_id VARCHAR(255),user2_id VARCHAR(255),created_at TIMESTAMP DEFAULT NOW(),updated_at TIMESTAMP DEFAULT NOW(), UNIQUE(user1_id, user2_id))');
