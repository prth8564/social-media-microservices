...
export async function getRowConversations(user_id) {
    const query = 'SELECT * FROM conversations WHERE user1_id = $1 OR user2_id = $1 ORDER BY created_at DESC';
...
export async function getRowMessages(conversation_id) {
